...
public class CSVBasedURLActionBase_Test extends AbstractCSVBasedURLAction_Test
{
    ...
    public void testNoURLFails() throws IOException
    {
        ...
        new CSVBasedURLAction(records.get(0));
    }
    ...
    public void testPOST_Encoded() throws IOException
    {
        ...
        Assert.assertTrue(compareParameters(action.getParameters(), "redirectUrl=/", "j_username=username",
                                            "j_password=password"));
        Assert.assertTrue(HttpResponseCodeValidator.getInstance().equals(action.getHttpResponseCodeValidator()));
    ...
    {
        final List<CSVRecord> records = createRecords("Name,URL,Method,Parameters,ResponseCode,RegExp,Text,Encoded",
    ...
    public void testTypeSupport_AllButResponseCode() throws IOException, EvalError
    {
        ...
        final List<CSVRecord> records = createRecords("Name,URL,Parameters,XPath,Text,RegExp,Method,Encoded,Type",
    ...
    {
        // test only the supported types
        final List<CSVRecord> records = createRecords("Name,URL,ResponseCode", "${k1},\"http://u${k2}.com/\",${k10}");

        new CSVBasedURLAction(records.get(0), new ParamInterpreter());
    }
    ...
    public void testPropertyReplacement_XltProperties() throws IOException
    {
        ...
        // test only the supported types
        final List<CSVRecord> records = createRecords("Name,URL,Parameters,XPath,Text,RegExp",
    ...
    public void testPropertyReplacement_PropertyHasBeanShellName() throws IOException, EvalError
    {
        ...
        // test only the supported types
        final List<CSVRecord> records = createRecords("Name,URL", "${p1},\"http://u${p2}.com/\"");
