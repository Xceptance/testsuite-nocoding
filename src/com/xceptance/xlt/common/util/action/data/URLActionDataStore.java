...
public class URLActionDataStore
{
    ...
    {
        this.selectionContent = (selectionContent != null)
                                                          ? selectionContent
    ...
    {
        this.subSelectionMode = (subSelectionMode != null)
                                                          ? subSelectionMode
    ...
    {
        this.subSelectionValue = (subSelectionValue != null)
                                                            ? subSelectionValue
    ...
    {
        final String message = MessageFormat.format("Store: \"{0}\", tag \"{1}\"  cannot be NULL", this.name, tag);
        return message;
    }
    ...
    {
        final String message = MessageFormat.format("Store: \"{0}\", Illegal value: \"{1}\" for tag \"{2}\"", this.name, value, tag);
        return message;
    }
}
